...
<body>
        <div class="profile-section">
            <img id="profileImage" src="<?php echo htmlspecialchars($profilePicture); ?>" alt="Profile Picture" class="profile-image" onclick="document.getElementById('profilePicture').click()">
        </div>
   ...
   <script>
      ...
      if (file) {
        ...
        .then(data => {
          if (data.status === 'success') {
            const newProfilePictureUrl = "../uploads/" + data.profilePicture;
            updateProfilePictureDisplay(newProfilePictureUrl); // อัปเดตรูปทันทีหลังจากอัปโหลด
          } else {
    ...
    function updateProfilePictureDisplay(url) {
      // อัปเดตรูปโปรไฟล์ใน navbar และหน้าโปรไฟล์ทันที
