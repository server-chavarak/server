...
if (isset($_GET['Act_ID'])) {
    ...
    if (!$actual_production) {
        ...
        header('Location: edit_inner_Paint.php');
        exit();
    }
}
...
if ($next_step_row) {
    ...
    header('Location: edit_inner_Paint.php?Act_ID=' . $act_id);
    exit();
}
...
<body>
    ...
    <form action="edit_inner_Paint.php" method="POST" id="addcustomer" class="form-container">
