...
if (isset($_GET['Act_ID'])) {
    ...
    if (!$actual_production) {
        ...
        header('Location: edit_spiral.php');
        exit();
    }
}
...
if ($next_step_row) {
    ...
    header('Location: edit_spiral.php?Act_ID=' . $act_id);
    exit();
}
...
<body>
    ...
    <form action="edit_spiral.php" method="POST" id="addcustomer" class="form-container">
