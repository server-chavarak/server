...
if (isset($_GET['Act_ID'])) {
    ...
    if (!$actual_production) {
        ...
        header('Location: edit_hydrotest.php');
        exit();
    }
}
...
if ($next_step_row) {
    ...
    header('Location: edit_hydrotest.php?Act_ID=' . $act_id);
    exit();
}
...
<body>
    ...
    <form action="edit_hydrotest.php" method="POST" id="addcustomer" class="form-container">
