...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $result = $pipeSize1;
    if (!empty($pipeSize2)) {
        $result .= (!empty($result) ? 'x' : '') . $pipeSize2;
    }
    if (!empty($pipeSize3)) {
        $result .= (!empty($result) ? 'x' : '') . $pipeSize3;
    }
    ...
    <div class="add">
        <form action="add_type.php" method="POST" id="addcustomer" >
            ...
            <div class="form-group">
                ...
                <div class="add_1"><a href="../manager/add_Type_Detail.php" class="add-link"> +</a></div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="add_1"><a href="../manager/add_PipeEnd_Detail.php" class="add-link"> +</a></div>
            </div>
