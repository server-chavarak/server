...
if (isset($_GET['Act_ID'])) {
    ...
    if (!$actual_production) {
        ...
        header('Location: edit_outer_paint.php');
        exit();
    }
}
...
if ($next_step_row) {
    ...
    header('Location: edit_outer_paint.php?Act_ID=' . $act_id);
    exit();
}
...
<body>
    <a href="Actual_production.php" class="back-link">ย้อนกลับ</a>
 
    <form action="edit_outer_paint.php" method="POST" id="addcustomer" class="form-container">
        ...
        if (isset($_SESSION['alertMessage'])) {
            ...
            echo "Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = 'Actual_production.php';
                }
            });";
